...
export function Hero () {
  return (
    <section id='hero' className='bg-[#101010] h-screen w-full pb-8 pl-4 md:pl-9 pr-4 md:pr-9 mb-32 md:mb-0'>
      <div className='md:flex items-center justify-between h-full md:flex-row max-w-[1200px] mx-[auto] my-[auto] flex flex-col'>
        ...
        <div id='buttons' className='mx-[auto] w-full flex flex-col justify-between text-center'>
          ...
          <button id='button' className='w-full mb-4'><Svg /></button>
        </div>
      </div>
      <div id='circle' />
      <div id='circle_' />
